...
urlpatterns = [
    ...
    path(
        "ai/recipes/<str:recipe_id>/",
        views.recipe_detail,
        {"source": "ai"},
        name="recipe_detail_ai",
    ),
    path(
        "web/recipes/<str:recipe_id>/",
        views.recipe_detail,
        {"source": "web"},
        name="recipe_detail_web",
    ),
    # detail for session-backed results (web/ai)
    path(
        "recipes/<str:source>/<int:recipe_id>/",
        views.recipe_detail,
        name="recipe_detail",
    ),
    # save to favorites for a session-backed result:
    path(
        "recipes/<str:source>/<slug:recipe_id>/save/",
        views.save_favorite,
        name="save_favorite",
    ),
    # Favorites (DB-backed)
    ...
    path(
        "targets/meals/<int:pk>/update/",
        views.update_logged_meal,
        name="update_logged_meal",
    ),
    # Meal logging
    ...
    path(
        "pantry/extract/start/", views.pantry_extract_start, name="pantry_extract_start"
    ),
    path(
        "pantry/extract/<int:upload_id>/review/",
        views.pantry_extract_review,
        name="pantry_extract_review",
    ),
    # Used by the dashboard "Upload & Review" form
    path(
        "pantry/upload-to-review/",
        views.pantry_extract_start,
        name="pantry_upload_to_review",
    ),
